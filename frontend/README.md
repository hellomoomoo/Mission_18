...
### 기능
1. 영화 목록 표시
2. 제목, 포스터 이미지, (옵션) 평균 평점 표시
3. 영화 추가
4. 입력: 제목, 개봉일, 감독, 장르, 포스터 URL
...
### 기능
1. 영화 관리
2. 등록: 제목, 개봉일, 감독, 장르, 포스터 URL (나무위키 참고)
3. 전체/특정 영화 조회
4. 특정 영화 삭제
...
1. 리뷰 관리
2. 등록, 전체/특정 영화 리뷰 조회, 삭제
3. 평점 조회
4. 리뷰 감성 분석 점수의 평균
5. 리뷰 감성 분석
6. 모델: 적절한 모델 리서치하여 적용
7. 모델 경량화 방식에 대해 고민해보기
